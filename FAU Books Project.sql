...
-- This is the creation of a database that stores data from a book company.
-- It also inserts some of the intial data.
...
-- Inserts the customer data into the Customers table
...
VALUES (1020, 'FALAH', 'KENNETH', 'P.O. BOX 335', 'TRENTON', 'NJ', '08607', NULL, 'NE'); 
 ...
 -- Creates the Orders Table which stores the Order#, Customer#, OrderDate, Ship Date,
...
ShipCost NUMERIC(4,2),
 ...
 -- Inserts the Orders data into the Orders table
INSERT INTO ORDERS
...
INSERT INTO ORDERS 
VALUES (1015,1020,('04-APR-09'),NULL,'507 GLITTER ST.', 'TRENTON', 'NJ', '08606', 2.00); 
INSERT INTO ORDERS 
...
VALUES (1020,1008,('05-APR-09'),NULL,'195 JAMISON LANE', 'CHEYENNE', 'WY', '82003', 2.00); 
 ...
 -- Creates the Publisher table that stores PubID, Name, Contact, Phone
...
-- Inserts data into the Publisher table 
...
VALUES(5,'REED-N-RITE','SEBASTIAN JONES','800-555-8284'); 
 ...
 --Creates the Author Table which stores AuthorID, Lname, Fname
CREATE TABLE Author 
(AuthorID VARCHAR(4), 
Lname VARCHAR(10), 
Fname VARCHAR(10),
...
VALUES ('W110','WILKINSON','ANTHONY'); 
 ...
 -- Creates the Books table which stores ISBN, Title, PubDate, PubID, Cost, 
 -- Retail, Discount, and Category
CREATE TABLE Books 
(ISBN VARCHAR(10), 
Title Varchar(30), 
PubDate DATE, 
...
VALUES ('2147428890','SHORTEST POEMS',('01-MAY-05'),5,21.85,39.95, NULL, 'LITERATURE'); 
 ...
 -- Creates Orderitems table which stores Order#, Item#, ISBN, Quantity, and Paideach
CREATE TABLE ORDERITEMS 
 ...
 -- Inserts data into OrderItems table
...
VALUES (1020,1,'3437212490',1,19.95); 
 ...
 -- Creates the BookAuthor Table that stores ISBN and AuthorID
...
(ISBN Varchar(10), 
 ...
 -- Inserts data into the BookAuthor table
...
-- Creates the promotion table which stores Minreatil and Maxretail
CREATE TABLE promotion 
(Gift  Varchar(15), 
 Minretail Numeric(5,2), 
 Maxretail Numeric(5,2)); 
 
 -- Inserts data into the promotion table.
...
-- Creates the acctmanager table which stores amid, amfirst, amlast, and region
...
region CHAR(2) NOT NULL);
 ...
 -- Creates the acctmanager2 table which stores amfirst, amlast, and region
